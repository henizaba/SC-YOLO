...
if __name__ == '__main__':
    ...
    image_dir = 'E:/VScode project/ultralytics-main/datasets/data5/img'
    txt_dir = 'E:/VScode project/ultralytics-main/datasets/data5/txt'
    save_dir = 'E:/VScode project/ultralytics-main/datasets/dataset3'
